...
- `internal/bridge`: stdio JSON-RPC bridge with workspace info, file
  list/search/diff/read/write/edit actions, diagnostics, sessions, and
  background watch notifications.
