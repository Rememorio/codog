...
func TestRunUsesMockProvider(t *testing.T) {
	...
	require.Equal(t, 2, workflowCategory.Total)
	require.ElementsMatch(t, []string{"command_skill_template_roundtrip", "onboarding_bookmarks_roundtrip"}, workflowCategory.Scenarios)
