...
func TestRunUsesMockProvider(t *testing.T) {
	...
	require.Equal(t, 2, roadmapCategory.Total)
	require.ElementsMatch(t, []string{"roadmap_pinpoint_lifecycle_roundtrip", "report_atomic_update_roundtrip"}, roadmapCategory.Scenarios)
