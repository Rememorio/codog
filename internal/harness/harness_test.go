...
func TestRunUsesMockProvider(t *testing.T) {
	...
	require.Equal(t, 3, preferencesCategory.Total)
	require.ElementsMatch(t, []string{"interface_preferences_roundtrip", "privacy_keybindings_roundtrip", "theme_lifecycle_roundtrip"}, preferencesCategory.Scenarios)
