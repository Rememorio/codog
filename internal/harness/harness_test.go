...
func TestRunUsesMockProvider(t *testing.T) {
	...
	require.Equal(t, 2, preferencesCategory.Total)
	require.ElementsMatch(t, []string{"interface_preferences_roundtrip", "theme_lifecycle_roundtrip"}, preferencesCategory.Scenarios)
