...
func TestRunUsesMockProvider(t *testing.T) {
	...
	require.Equal(t, 7, reportBackpressure.ToolCalls)
	require.Equal(t, 7, reportBackpressure.RequestCount)
	require.Equal(t, []string{"roadmap_pinpoint", "report_backpressure", "report_backpressure", "roadmap_pinpoint", "report_backpressure", "report_backpressure", "report_backpressure"}, reportBackpressure.ToolUses)
