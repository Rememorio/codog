...
func TestRunUsesMockProvider(t *testing.T) {
	...
	require.Equal(t, 28, lspStatic.ToolCalls)
	require.Equal(t, []string{"lsp", "lsp", "lsp", "lsp", "lsp", "lsp", "lsp", "lsp", "lsp", "lsp", "lsp", "lsp", "lsp", "lsp", "lsp", "lsp", "lsp", "lsp", "lsp", "lsp", "lsp", "lsp", "lsp", "lsp", "lsp", "lsp", "lsp", "lsp"}, lspStatic.ToolUses)
