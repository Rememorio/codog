...
func TestRunUsesMockProvider(t *testing.T) {
	...
	require.Equal(t, 4, roadmapPinpoint.ToolCalls)
	require.Equal(t, 4, roadmapPinpoint.RequestCount)
	require.Equal(t, []string{"roadmap_pinpoint", "roadmap_pinpoint", "roadmap_pinpoint", "roadmap_pinpoint"}, roadmapPinpoint.ToolUses)
