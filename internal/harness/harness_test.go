...
func TestRunUsesMockProvider(t *testing.T) {
	...
	require.Equal(t, 2, modelRuntimeCategory.Total)
	require.ElementsMatch(t, []string{"model_runtime_preferences_roundtrip", "model_selection_roundtrip"}, modelRuntimeCategory.Scenarios)
