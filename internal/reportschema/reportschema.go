...
func RegistryV1() Registry {
	return Registry{
		...
		Fields: []RegistryField{
			...
			field("new_items[].dedupe_key", "stable key for collapsing duplicate roadmap pinpoints", false, "items"),
			field("new_items[].same_root_cause[]", "related filing ids collapsed into the canonical roadmap pinpoint", false, "items"),
			field("changed_items[].dedupe_key", "stable key for collapsing duplicate roadmap pinpoints", false, "items"),
			field("changed_items[].same_root_cause[]", "related filing ids collapsed into the canonical roadmap pinpoint", false, "items"),
