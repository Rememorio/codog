...
func Specs() []Spec {
	specs := []Spec{
		...
		{Name: "/hooks", Usage: "/hooks [list|run pre|post|post-failure|user-prompt-submit|session-start|stop|stop-failure|pre-compact]", Description: "Inspect or test configured hooks."},
