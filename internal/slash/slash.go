...
func Specs() []Spec {
	specs := []Spec{
		...
		{Name: "/skill", Usage: "/skill [list|show|invoke|add|install|uninstall]", Description: "Alias for /skills."},
		{Name: "/skills", Usage: "/skills [list|show|invoke|add|install|uninstall]", Description: "List, show, install, remove, or render Markdown skills."},
