	...
	return anthropic.ToolDefinition{
		...
		InputSchema: map[string]any{
			...
			"properties": map[string]any{
				"action": map[string]any{
					"type": "string",
					"enum": []string{"symbols", "document_symbols", "workspace_symbol", "workspace_symbols", "references", "find_references", "diagnostics", "definition", "goto_definition", "declaration", "goto_declaration", "implementation", "goto_implementation", "type_definition", "goto_type_definition", "rename", "rename_symbol", "prepare_rename", "code_action", "quickfix", "hover", "completion", "completions", "document_highlight", "selection_range", "folding_range", "document_link", "document_color", "inlay_hint", "linked_editing_range", "moniker", "semantic_tokens", "semantic_tokens_full", "semantic_tokens_range", "signature_help", "format", "formatting"},
				},
				"path":      map[string]any{"type": "string"},
...
func lspActionRequiresServer(action string) bool {
	switch action {
	case "declaration", "implementation", "type-definition", "rename", "prepare-rename", "code-action", "document-highlight", "selection-range", "folding-range", "document-link", "document-color", "inlay-hint", "linked-editing-range", "moniker", "semantic-tokens", "semantic-tokens-range", "workspace-symbol", "signature-help":
		return true
	default:
		return false
	}
