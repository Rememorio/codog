	...
	return anthropic.ToolDefinition{
		...
		InputSchema: map[string]any{
			...
			"properties": map[string]any{
				"action": map[string]any{
					"type": "string",
					"enum": []string{"symbols", "document_symbols", "workspace_symbol", "workspace_symbols", "references", "find_references", "diagnostics", "definition", "goto_definition", "declaration", "goto_declaration", "implementation", "goto_implementation", "type_definition", "goto_type_definition", "rename", "rename_symbol", "prepare_rename", "code_action", "quickfix", "code_lens", "code_lens_resolve", "prepare_call_hierarchy", "incoming_calls", "outgoing_calls", "prepare_type_hierarchy", "supertypes", "subtypes", "hover", "completion", "completions", "document_highlight", "selection_range", "folding_range", "document_link", "document_color", "color_presentation", "inlay_hint", "linked_editing_range", "moniker", "semantic_tokens", "semantic_tokens_full", "semantic_tokens_range", "signature_help", "format", "formatting"},
				},
				"path":      map[string]any{"type": "string"},
